...
class ConsumptionPairDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        # A Siamese pair must undergo the same spatial transform. Sampling a
        # flip separately for before/after creates synthetic visual changes
        # unrelated to consumption in half of the augmented pairs.
        flip_horizontal = self.train_mode and torch.rand(1).item() < 0.5
